...
class Invalid_Data:
    ...
    first_name_1_char = 'Б'
    first_name_31_char = 'БулкинаБулкинаБулкинаБулкинаБул'
    last_name_1_char = 'М'
    last_name_31_char = 'МарияМарияМарияМарияМарияМарияМ'
    password_21_char = 'Qwerty0Qwerty0Qwerty0'
    password_no_Lower = 'qwertyu0'
    password_9_char = 'Qwertyu0p'
    password_not_contain_digit = "Qwertyu"
    xss = '<script>alert(123)</script>'
    email_without_domain = 'test@.ru'
    invalid_phoneNumber = '+79999999999'

class Valid_Data:
    valid_first_name = 'Мария'
    valid_last_name = 'Булкина'
